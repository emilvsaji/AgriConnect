  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 px-4 py-12 sm:px-6 lg:px-8">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-16 left-8 h-64 w-64 rounded-full bg-green-200/60 blur-3xl" />
        <div className="absolute top-24 right-8 h-72 w-72 rounded-full bg-emerald-200/60 blur-3xl" />
        <div className="absolute bottom-0 left-1/4 h-72 w-72 rounded-full bg-teal-200/60 blur-3xl" />
      </div>
      ...
      <div className="relative mx-auto grid w-full max-w-6xl items-center gap-8 lg:grid-cols-2">
        <div className="hidden space-y-6 rounded-3xl border border-green-100 bg-white/70 p-10 shadow-xl backdrop-blur-sm lg:block">
          <div className="inline-flex items-center gap-2 rounded-full border border-green-100 bg-white px-4 py-2 shadow-sm">
            ...
            <span className="text-sm font-semibold text-gray-700">Welcome Back to AgriConnect</span>
          </div>
          <h1 className="text-4xl font-bold leading-tight text-gray-900">
            Sign in and continue growing with
            <span className="block bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">smart farming tools</span>
          </h1>
          <p className="text-gray-600">
            Access your dashboard, track orders, and connect directly with buyers and tools built for modern farmers.
          </p>
          <div className="space-y-3 pt-2">
            <div className="flex items-center gap-2 text-gray-700">
              <HiCheckCircle className="h-5 w-5 text-green-600" />
              <span>Fast and secure account access</span>
            </div>
            <div className="flex items-center gap-2 text-gray-700">
              <HiCheckCircle className="h-5 w-5 text-green-600" />
              <span>Manage products, tools, and orders in one place</span>
            </div>
            <div className="flex items-center gap-2 text-gray-700">
              <HiCheckCircle className="h-5 w-5 text-green-600" />
              <span>Built for a seamless farm-to-market workflow</span>
            </div>
          </div>
        </div>
        ...
        <div className="w-full rounded-3xl border border-green-100 bg-white p-8 shadow-2xl sm:p-10">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">Continue to your AgriConnect dashboard</p>
